...
/*
	public Collection<Thing> getDocumentLinks(OulipoRequest oulipoRequest) {
		...
		String[] toParams = queryParams.get("to") != null ? queryParams.get("to").split("[,]") : null;
		String[] fromParams = queryParams.get("from") != null ? queryParams.get("from").split("[,]") : null;

		if (toParams != null || fromParams != null) {
			String[] typeParams = queryParams.get("type") != null ? queryParams.get("type").split("[,]") : null;

			RangeTumblerMatcher fromMatcher = RangeTumblerMatcher.createFromInvariantSpans(toParams);
			RangeTumblerMatcher toMatcher = RangeTumblerMatcher.createFromInvariantSpans(fromParams);
