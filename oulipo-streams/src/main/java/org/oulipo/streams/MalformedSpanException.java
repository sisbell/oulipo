...
public class MalformedSpanException extends Exception {
	...
	public MalformedSpanException(String message, Throwable cause) {
		super(message, cause);
	}

	public MalformedSpanException(String message, Throwable cause, boolean enableSuppression,
			boolean writableStackTrace) {
		super(message, cause, enableSuppression, writableStackTrace);
	}

	public MalformedSpanException(Throwable cause) {
		super(cause);
	}
