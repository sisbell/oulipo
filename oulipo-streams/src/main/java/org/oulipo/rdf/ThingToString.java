...
import static org.oulipo.rdf.DataType.XSD_GDAY;
import static org.oulipo.rdf.DataType.XSD_GMONTH;
import static org.oulipo.rdf.DataType.XSD_GYEAR;
...
import static org.oulipo.rdf.EscapeUtils.escapeString;
...
public final class ThingToString {

	private static final Logger LOG = Logger.getLogger("RdfRepository");

	public static void addObjectLiteral(RdfObject object, StringBuilder sb) {
	...
	public static void addObjectLiteralString(RdfObject object, StringBuilder sb) {
		Literal objectLiteral = ResourceFactory.createPlainLiteral(object.getValue());
		sb.append("\"").append(escapeString(objectLiteral.toString())).append("\"");
	}

	public static void addObjectResource(RdfObject object, StringBuilder sb) {
		Resource obj = ResourceFactory.createResource(object.getValue());
		sb.append("<").append(obj.toString()).append(">");
	}

	public static void addPredicate(RdfPredicate predicate, StringBuilder sb) {
